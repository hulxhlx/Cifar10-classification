...
class VGGSVM:
    def __init__(self, alpha, batch_size, num_classes, num_features, penalty_parameter):
        ...
        def __graph__():
            ...
            conv2_1 = self.Conv_layer(maxPooling1, filters=128, kernel_size=(3, 3), drop=False)
            conv2_2 = self.Conv_layer(conv2_1, filters=128, kernel_size=(3, 3), drop=False)
            maxPooling2 = MaxPooling2D(pool_size=(2, 2))(conv2_2)
            conv3_1 = self.Conv_layer(maxPooling1, filters=256, kernel_size=(3, 3), drop=False)
            conv3_2 = self.Conv_layer(conv3_1, filters=256, kernel_size=(3, 3), drop=False)
            conv3_3 = self.Conv_layer(conv3_2, filters=256, kernel_size=(3, 3), drop=False)
            conv3_4 = self.Conv_layer(conv3_3, filters=256, kernel_size=(3, 3), drop=False)
            maxPooling3 = MaxPooling2D(pool_size=(2, 2))(conv3_4)
            conv4_1 = self.Conv_layer(maxPooling3, filters=512, kernel_size=(3, 3), drop=False)
            conv4_2 = self.Conv_layer(conv4_1, filters=512, kernel_size=(3, 3), drop=False)
            conv4_3 = self.Conv_layer(conv4_2, filters=512, kernel_size=(3, 3), drop=False)
            conv4_4 = self.Conv_layer(conv4_3, filters=512, kernel_size=(3, 3), drop=False)
            maxPooling4 = MaxPooling2D(pool_size=(2, 2))(conv4_4)
            conv5_1 = self.Conv_layer(maxPooling4, filters=512, kernel_size=(3, 3), drop=False)
            conv5_2 = self.Conv_layer(conv5_1, filters=512, kernel_size=(3, 3), drop=False)
            conv5_3 = self.Conv_layer(conv5_2, filters=512, kernel_size=(3, 3), drop=False)
            conv5_4 = self.Conv_layer(conv5_3, filters=512, kernel_size=(3, 3), drop=False)
