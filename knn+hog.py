...
class Classifier(object):
	...
	def classification(self, train_feat, test_feat):
		...
		# 		bestK = k
		# 		bestWeight = "uniform"
		# 	print("when the weight is uniform and n_neighbors =" , k,"the score is",scor)
		#
		# # weight==distance时
		# for k in range(1, 10):
		...
		# 		bestK = k
		# 		bestWeight = "distance"
		# 	print("when the weight is distance and n_neighbors =" , k, "the score is",scor)
		...
		#x_train = train_feat[:, :-1], y_train = train_feat[:, -1]
